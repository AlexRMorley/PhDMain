        ...
        while heap:
            ...
            for dx,dy in NBR4:
                ...
                if shadow_interior is not None and shadow_interior[nx,ny]:
                    if not relay_ok_fn((nx, ny)): continue
                if tb==T_UNKNOWN:
                    if has_land and not has_water and not has_air:
                        wa=fb=False
                        for ddx,ddy in NBR4:
...
class FleetSim:
    def __init__(self):
        ...
        # Used ONLY in __init__ for zone precomputation (e.g. _zone_stair_frac,
        # disc_cluster_border_has_water). Policy/decision code MUST use the
        ...
        # legitimate here, same category as _zone_stair_frac — this is a map
    ...
    def _cell_is_relay_covered(self, cell):
        ...
        return cell in self._active_relay_coverage_union()
